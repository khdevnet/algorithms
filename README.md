...
* **Big O (Big O)**: notation defines an upper bound of an algorithm, it bounds a function only from above.
* **Ω (Omega)** notation defines a lower bound on time complexity of an algorithm. 
